...
int main (int ac, char *av[]){
	...
	char *file1;
	char pcifile[2][23] = {"/proc/bus/pci/00/06.0", "/proc/bus/pci/00/07.0"};
	
	for( i = 0; i < 2; i++)
	        if(access(pcifile[i], F_OK) == 0)
	        {
	                file1 = pcifile[i];
	                break;
                }
...
#if WRITE_ == 1 && MAC_ == 0 && NETCARD_TYPE == 3
	/***write 8100 eeprom***/
	unsigned short eeprom_data[]=
		{
			0x8129, 0x10ec, 0x8139, 0x10ec, 0x8139, 0x4020, 0xe512, 0xe000,
			0x394c, 0x0100, 0x8d10, 0xf7c2, 0x8801, 0x03b9, 0x60f4, 0x071a,
			0xdfa3, 0x9836, 0xdfa3, 0x9836, 0x03b9, 0x60f4, 0x1a1a, 0x1a1a,
			0x0000, 0x44d1, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x2000,
			0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
			0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
			0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
			0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
